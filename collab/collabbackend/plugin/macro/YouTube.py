# -*- coding: iso-8859-1 -*-
u"""
    *** MODIFIED FOR SECURE CONTENT (http -> https) URLS for Collab Use ***
    ...
    if keyword is not None:
        ...
        <div class="youtube youtube_keyword">
            ...
            <p class="youtube_link" style="display:none;">
                <a href="https://www.youtube.com/results?search_query=%(keyword)s">%(msg_youtubelink)s</a>
            </p>
        </div>
        """ % parameters
    ...
    if id is not None:
        ...
        <div class="youtube %(id)s">
            ...
            <object width="425" height="344"> 
                <param name="movie" value="https://www.youtube.com/v/%(id)s&rel=0&fs=1"></param>
                <param name="rel" value="0"></param>
                <param name="wmode" value="transparent">
                <param name="allowFullScreen" value="true"></param>
                <embed src="https://www.youtube.com/v/%(id)s&fs=1&rel=0"
                    wmode="transparent"
            ...
            <p class="youtube_link" style="display:none;">
                <a href="https://www.youtube.com/v/%(id)s&fs=1&rel=0">%(msg_youtubelink)s</a>
            </p>
