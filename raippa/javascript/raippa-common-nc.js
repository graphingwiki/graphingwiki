...
/**
 * Raippa spesific extensions
 * requires mootools and more extensions: Accordition, Date, Drag.Move,
 *  Sortables, Assets and Tips + Fx.reveal, class.occludes, class.binds
 *  Fx.Slide
 * 
 */
...
Date.implement({
	getFinWeek : function(){
		return ((this.get('dayOfYear')+ this.clone().set('month',0).set('date',1).getFinDay())/7).ceil()
	},
	getFinDay : function(){
