/*
 ...
 Author: Lauri Pokka
 Provides: [Request.{SetMetas,GetMetas}, gwiki.{Overlay,Overlay,GwikiDynamicTextArea,GwikiImport}]
 */

window.gwiki = window.gwiki || {};
window.gwiki.dateformat = '%Y-%m-%d';
window.gwiki.GWIKISEPARATOR = '-gwikiseparator-';
...
/* Extensions to Mootools Slick, Element.Events, Date and Object classes */
...
(function(exports) {
    "use strict";
    exports.InlineEditor = new Class({
        ...
        build: function() {
            ...
            if (type == "date") {
                ...
                var field = this.options.size == "compact" ? DynamicTextarea : exports.GwikiDynamicTextarea;
                new field(this.input).addEvent('resize', function() {
                    this.input.fireEvent('resize');
                }.bind(this));

                if (this.options.key) {
                    this.suggestions = new exports.MetaSuggestions(this.input, {
...
(function(exports) {
    "use strict";
    exports.GwikiDynamicTextarea = function(textarea, options) {
        if (!exports.GwikiDynamicTextarea_) {
            exports.GwikiDynamicTextarea_ = new Class({
        ...
        return new exports.GwikiDynamicTextarea_(textarea, options);
    };
})(window.gwiki);
...
(function(exports) {
    ...
    exports.GwikiImport = new Class({
        ...
        missingDeps: function() {
            var deps = Array.prototype.slice.call(arguments).flatten(), missing = [], module;
            while (deps.length > 0) {
                module = deps.shift();
                deps.append(DEPS[module].depends);
                if (!this.loaded.contains(module)) missing.include(module);
            }
...
(function(exports) {
    ...
    var GwikiImport = exports.GwikiImport;
    ...
    window.addEvent('domready', function() {
        ...
        if (fields.length > 0) {
            loader.load('MetaFormEdit', function() {
                new exports.MetaFormEdit(fields[0].getParent('form'));
            });
        }
        ...
        if ($$('div.InterMetaTable').length) {
            loader.load('MetaTable', function() {
                $$('div.InterMetaTable').each(function(table) {
                    ...
                    new exports.InterMetaTable(table, opts);
                });
            });
        }
                ...
                if (document.body) {
                    document.id(document.body).addEvent('focus:relay(textarea.dynamic)', function(e) {
                        if (!document.id(e.target).retrieve('dynamic')) {
                            new exports.DynamicTextarea(e.target);
    ...
    var initInlineMetaEdit = function(base) {
        ...
        if (base.hasClass('gwikiinclude')) page = unescapeId(base.id).split(exports.GWIKISEPARATOR)[0];
        ...
        var editValue = function(dd) {
            ...
            editor = new exports.InlineEditor(dd, {
                oldValue: oldValue,
                key: key,
                inline: true,
                width: 40,
        ...
        var editKey = function(dt) {
            ...
            editor = new exports.InlineEditor(dt, {
                oldValue: key,
                inline: true,
