...
def surlper( urlToSurlp, wikiName = "http://pan0228.panoulu.net/" ):
    ...
    #The vmware-image that we will use for the urling
    ...
    #The image will contact the server for the URL that is to be analysed.
    #When this is done, start the clock, and 
    indexer = 0
